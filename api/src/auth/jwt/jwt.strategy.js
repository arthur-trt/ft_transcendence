...
var JwtStrategy = /** @class */ (function (_super) {
    ...
    JwtStrategy.prototype.validate = function (request, payload) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.getUserByIdentifier(payload.sub)];
                    case 1:
                        user = _a.sent();
                        if (!user.TwoFA_enable)
                            return [2 /*return*/, { userId: payload.sub }];
