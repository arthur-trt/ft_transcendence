...
var WsJwtAuthGuard = /** @class */ (function () {
    function WsJwtAuthGuard(jwtService, userService) {
        this.jwtService = jwtService;
        this.userService = userService;
    }
    WsJwtAuthGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var client, authCookies, authCookie, authToken, jwtOptions, jwtPayload, user, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        jwtPayload = _a.sent();
                        return [4 /*yield*/, this.userService.getUserByIdentifier(jwtPayload.sub)];
                    case 2:
                        user = _a.sent();
                    ...
                    case 3:
                        ...
                        throw new websockets_1.WsException(err_1.message);
